...
public class MesaGUI extends JFrame {
  ...
  public MesaGUI() {
        ...
        addFormRow(formPanel, gbc, 0, "Restaurante:", new JComboBox<>(new String[]{"La Parrilla", "Sushi Roll"}));
        addFormRow(formPanel, gbc, 1, "ID Mesa:", new JTextField());
        addFormRow(formPanel, gbc, 2, "Número:", new JTextField());
        addFormRow(formPanel, gbc, 3, "Capacidad:", new JTextField());
        ...
        // --- Panel Central (Tabla) ---
        String[] columnas = {"ID Mesa", "Restaurante", "Número", "Capacidad"};
        Object[][] datos = {
            {"1", "La Parrilla", "12", "4"},
            {"2", "Sushi Roll", "5", "2"}
        };
        ...
        scrollPane.setBorder(BorderFactory.createTitledBorder("Lista de Mesas"));
