...
public class RestauranteGUI extends JFrame {
   ...
   public RestauranteGUI() {
        ...
        JButton btnIrMesas = new JButton("Ir a Mesas");
        btnIrMesas.addActionListener(e -> new MesaGUI().setVisible(true));
        topPanel.add(btnIrMesas);
        ...
        formPanel.setBorder(BorderFactory.createTitledBorder("Datos del Restaurante"));
        ...
        addFormRow(formPanel, gbc, 2, "Teléfono:", new JTextField());
        addFormRow(formPanel, gbc, 3, "Tipo Cocina:", new JTextField());
        ...
        // --- Panel Central (Tabla) ---
        String[] columnas = {"ID", "Nombre", "Teléfono", "Tipo Cocina"};
        Object[][] datos = {
            {"1", "La Parrilla", "6442345678", "Cortes de Carne"},
            {"2", "Sushi Roll", "6448765432", "Japonesa"}
        };
        JTable table = new JTable(new DefaultTableModel(datos, columnas));
        JScrollPane scrollPane = new JScrollPane(table);
        // Título de la tabla actualizado
        scrollPane.setBorder(BorderFactory.createTitledBorder("Lista de todos los restaurantes"));
